 ...
 */
final class Version20200327073439 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE galerie (id INT AUTO_INCREMENT NOT NULL, photo VARCHAR(255) NOT NULL, auteur VARCHAR(155) NOT NULL, descriptif LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
